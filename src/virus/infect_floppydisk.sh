...
dd if=/dev/zero of=../../build/floppy.flp bs=512 count=2880 # Criação do FloppyDisk Principal
dd if=/dev/zero of=../../build/floppy_2.flp bs=512 count=2880 # Criação do FloppyDisk que será infectado por autopropagação.
